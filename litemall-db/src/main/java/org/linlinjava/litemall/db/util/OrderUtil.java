...
public class OrderUtil {
    ...
    public static final Short STATUS_DONE = 501;
...
//            status.add((short)402);
    ...
    public static boolean isDoneStatus(LitemallOrder litemallOrder) {
        return OrderUtil.STATUS_DONE == litemallOrder.getOrderStatus().shortValue();
    }
}
