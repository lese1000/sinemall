...
public class WxCartController {
    ...
    public Object index(@LoginUser Integer userId) {
        ...
        List<Integer> productIsDownList = new ArrayList<>();
        for (LitemallCart cart : cartList) {
            ...
            LitemallProduct product = productService.findById(cart.getProductId());
            cart.setProductIsDown(product.getDeleted());
            if(product.getDeleted()) {
            	productIsDownList.add(product.getId());
            }
        }
        cartService.updateCheck(userId, productIsDownList, false);
